...
public class MatchViewManager : MonoBehaviour {
	...
	public void SetSelected(int i) {
		...
		statsPanel.transform.FindChild(Constants.VIEW_MATCH_STAT_CON_SLIDER).GetComponent<Slider>().maxValue = float.Parse(selectedChicken[Constants.DB_KEYWORD_CONDITIONING_MAX].ToString());
