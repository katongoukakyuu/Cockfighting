...
public class MatchCreateManager : MonoBehaviour {
	...
	public void SetSelected(string s) {
		...
		statsPanel.transform.FindChild(Constants.CREATE_MATCH_STAT_CON_SLIDER).GetComponent<Slider>().maxValue = float.Parse(selectedChicken[Constants.DB_KEYWORD_CONDITIONING_MAX].ToString());
